...
let lib = {
    ...
    "init": function (req, cb) {
        ...
        if (req.soajs.servicesConfig.passportLogin[mode].userProfileURL) {
            userProfileURL = req.soajs.servicesConfig.passportLogin[mode].userProfileURL;
        }
        let data = {
            strategy: require('passport-twitter').Strategy,
            authentication: 'twitter',
            configAuth: {
                consumerKey: req.soajs.servicesConfig.passportLogin[mode].clientID,
                consumerSecret: req.soajs.servicesConfig.passportLogin[mode].clientSecret.trim(),
