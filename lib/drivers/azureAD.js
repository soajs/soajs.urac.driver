    ...
    "init": function (req, cb) {
        ...
        let data = {
            ...
            configAuth: {
                ...
                isB2C: req.soajs.servicesConfig.urac.passportLogin[mode].isB2C,
                policyName: req.soajs.servicesConfig.urac.passportLogin[mode].policyName,
                loggingNoPII: req.soajs.servicesConfig.urac.passportLogin[mode].loggingNoPII,
                clockSkew: req.soajs.servicesConfig.urac.passportLogin[mode].clockSkew,
                scope: req.soajs.servicesConfig.urac.passportLogin[mode].scope,
            }
        };
        return cb(null, data);
    },
